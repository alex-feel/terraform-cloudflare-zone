...
* If you try to set a value for the `security_level` setting that is not available on your current plan, the setting value will be set to the closest value available on your current plan.
